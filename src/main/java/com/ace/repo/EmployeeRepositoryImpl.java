...
public class EmployeeRepositoryImpl implements EmployeeRepository {
	...
	public Employee findByEmpId(BigInteger empId) {
		...
		// every connection need to be closed after the query is executed successfuly(if
		// we use direct jdbc )
		// (if we are using connection pooling then we need not to close the connection
		// it was managed by the connection pooling third party jar)
		// if we will use try with resources then there is no need to write the finally
		// block
		// try with resources will automatically close the connection after try or catch
		// block executed
